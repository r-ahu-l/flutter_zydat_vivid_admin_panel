...
class AppColors {
  ...
  static const tertiary = Color(0xFF6D6D6D);
  static const primaryBg = Color(0xfff5f5fd);
  static const secondaryBg = Color(0xffececf6);
  static const barBg = Color(0xffe3e3ee);
  static const verticalDivider = Color(0xFFD5D5D6);
  static const tableHeaderBg = Color(0xFFE7E4E4);
  static const buttonBg = Color(0xFF03b1fc);
}
